...
license: MIT
allowed-tools: Bash Read audit-log
metadata:
  author: "gitrails"
  version: "1.0.0"
...
1. Run `node retrieval/index.js --query "hardcoded credentials auth key secret"` and `node retrieval/graph.js --hotspots --threshold 8` using Bash.
